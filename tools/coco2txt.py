...
parser.add_argument('--json_path',
                    default=r'D:\Computer_Version\for_paper\ultralytics-main-v1\datasets\T-less14-increased-3th\coco\keypoints.json', type=str,
                    help="input: coco format(json)")
# 这里设置.txt文件保存位置
parser.add_argument('--save_path', default=r"D:\Computer_Version\for_paper\ultralytics-main-v1\datasets\T-less14-increased-3th\txt", type=str,
