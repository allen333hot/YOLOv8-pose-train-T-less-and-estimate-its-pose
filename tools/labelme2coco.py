...
if __name__ == '__main__':
    ...
    parser.add_argument("--class_name", default="T-less14", help="class name", type=str)
    parser.add_argument("--input",  default=r"D:\Computer_Version\for_paper\ultralytics-main-v1\datasets\T-less14-increased-3th\labels_in_labelme", help="json file path (labelme)", type=str)
    parser.add_argument("--output", default=r"D:\Computer_Version\for_paper\ultralytics-main-v1\datasets\T-less14-increased-3th\coco", help="output file path (coco format)", type=str)
